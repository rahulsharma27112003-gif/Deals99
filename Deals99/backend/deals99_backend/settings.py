"""
Django settings for deals99_backend project.
"""
...
SECURE_CONTENT_SECURITY_POLICY = {
    'DEFAULT_SRC': ("'self'",),
    'SCRIPT_SRC': ("'self'", "cdnjs.cloudflare.com", "cdn.jsdelivr.net"),
    'STYLE_SRC': ("'self'", "cdnjs.cloudflare.com", "cdn.jsdelivr.net", "fonts.googleapis.com"),
    'FONT_SRC': ("'self'", "cdnjs.cloudflare.com", "fonts.gstatic.com"),
